export default {
  devices: {
    ...
    mqttWarning: 'When the device is connected to the MQTT server, client_id is the device ID. Token is also known as password.',
    mqtt: 'MQTT Server',
    mqttssBroker: 'Cert',
    CoAP: 'CoAP Server',
    coapssBroker: 'Cert',
    ...
    hour: 'Hour',
    everyHour: 'Every {min} minutes over an hour',
    everyDay: 'Every Day',
    minutes: 'Minutes',
